...
export default function AgentLeadManagement() {
  ...
  const getLeadDisplay = (task) => {
    const lead = leads.find(
      (l) => l.id === task.leadId || l.uuid === task.leadId,
    );
    if (lead) {
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-0.5 text-sm text-slate-500">
                    Track your active pipeline and upcoming tasks.
                  </p>
                </div>
              </div>
              ...
              <section className="grid grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <StatCard
                  ...
                  change={convertedLeads > 0 ? "Success" : ""}
                      ...
                      <table className="min-w-full text-left text-sm">
                        ...
                        <tbody className="divide-y divide-slate-100">
                          {filteredLeads.map((lead) => {
                            const pc =
                              priorityConfig[lead.leadPriority] ||
                              priorityConfig.cold;
                            ...
                            return (
                              ...
                              >
                                ...
                                <td className="px-6 py-4">
                                  <span
                                    className={`inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-bold ${pc.class}`}
                                  >
                                ...
                                <td className="px-6 py-4">
                                  <span
                                    className={`rounded-full px-2.5 py-0.5 text-xs font-bold ${statusClass[lead.status] || "bg-slate-100 text-slate-600"}`}
                                  >
                ...
                <section className="w-full xl:w-[340px] space-y-6">
                  ...
                  <div className="rounded-lg border border-slate-200 bg-white shadow-sm overflow-hidden">
                    <div className="bg-blue-700 px-5 py-4 flex items-center justify-between text-white">
                      ...
                      <span className="rounded bg-white/20 px-2 py-0.5 text-xs font-bold">
                        {tomorrowFollowUps.length} TASKS
                      </span>
                    </div>
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="flex items-end gap-2">
        ...
        {change && (
          <span className={`text-xs font-bold mb-0.5 ${changeClass}`}>
            {change}
          </span>
        )}
      </div>
