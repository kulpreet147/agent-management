            ...
            <div className="mx-auto max-w-6xl space-y-5">
              ...
              <section className="rounded-lg border border-slate-300 bg-white shadow-card">
                <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                  <div>
                    <h2 className="text-base font-bold">Document Review</h2>
                    <p className="mt-0.5 text-xs text-slate-500">Your submitted documents are approved and ready.</p>
                  </div>
                  <span className="rounded bg-emerald-50 px-2 py-1 text-xs font-bold uppercase text-emerald-700">
                    Approved
                  </span>
                </div>
                      ...
                      {documents.map((document) => (
                        <tr key={document.name} className="hover:bg-slate-50">
                          ...
                          <td className="px-5 py-4 text-right">
                            <button className="rounded-md border border-slate-300 bg-white px-3 py-1.5 text-xs font-bold text-slate-700 hover:bg-slate-50">
                              {document.action}
                            </button>
                          </td>
                        </tr>
