      ...
      <section className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <button
                      type="button"
                      onClick={() =>
                        navigate(`/admin/leads/${lead.id}`, { state: { lead } })
                      }
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2 bg-slate-100 px-2 py-1 rounded-full w-fit">
                      <div
                        className={`w-5 h-5 rounded-full ${initialsBg[lead.agentInitials] || "bg-blue-500"} flex items-center justify-center text-white text-[8px] font-bold`}
                      >
                        {lead.agentInitials}
                      </div>
        ...
        <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-between bg-white">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="w-8 h-8 rounded bg-blue-600 text-white text-xs font-bold">
              1
            </button>
            <button className="w-8 h-8 rounded hover:bg-slate-50 text-xs font-bold text-slate-600">
              2
            </button>
            <button className="w-8 h-8 rounded hover:bg-slate-50 text-xs font-bold text-slate-600">
              3
